...
function CreateUnitsForPlayer7 takes nothing returns nothing
    ...
    set u = BlzCreateUnitWithSkin( p, 'hfoo', 107.4, 2647.5, 16.755, 'hfoo' )
    set u = BlzCreateUnitWithSkin( p, 'hfoo', 116.5, 2524.5, 219.964, 'hfoo' )
    set u = BlzCreateUnitWithSkin( p, 'hfoo', 127.3, 2383.5, 167.700, 'hfoo' )
    set u = BlzCreateUnitWithSkin( p, 'hrif', -7.8, 2671.3, 227.226, 'hrif' )
    set u = BlzCreateUnitWithSkin( p, 'hrif', -13.4, 2517.5, 160.724, 'hrif' )
    set u = BlzCreateUnitWithSkin( p, 'hkni', -14.9, 2385.7, 304.935, 'hkni' )
    set u = BlzCreateUnitWithSkin( p, 'hmpr', -136.7, 2532.8, 244.310, 'hmpr' )
endfunction
